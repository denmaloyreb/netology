...
SELECT a.aircraft_code, a.model, COUNT(s.seat_no) as "Count_of_seats"
FROM aircrafts a
JOIN seats s
...
SELECT a.aircraft_code, a.model, array_agg(DISTINCT s.fare_conditions) as "Types_of_seats"
FROM aircrafts a 
JOIN seats s 
ON a.aircraft_code = s.aircraft_code
GROUP BY a.aircraft_code
